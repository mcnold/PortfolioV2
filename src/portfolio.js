  ...
  data: [
    {
      ...
      skills: [
        ...
        "⚡ Create server-side APIs in Node, Express & Flask",
        "⚡ Integrate third party services such as AtlasDB/ AWS / Heroku",
      ],
      softwareSkills: [
        {
          skillName: "HTML5",
  ...
  degrees: [
    {
      ...
      descriptions: [
        ...
        "⚡ I have studied core Business subjects as well as Data Structures, DBMS, Machine Learning, and Data Visualization.",
      ],
    ...
    },
    {
      ...
      descriptions: [
        ...
        "⚡ Undergraduate Foundations in Core Business Functions with expansion in Marketing Concepts",
      ],
